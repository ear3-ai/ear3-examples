...
import { Ear3InterviewIframe } from '@ear3/react'
  ...
  return (
    ...
    >
      <Ear3InterviewIframe
        ...
        onComplete={(event) => {
          // Client-side navigation — but the real source of truth is the
          // server-side webhook. See app/api/webhooks/ear3/route.ts.
